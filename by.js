...
const generateHeaders = (browser) => {
    ...
    const userAgent = {
        chrome: Math.random() < 0.5 ? `${generateRandomString(5,8)}+Mozilla/5.0 (Windows NT 10.0; Win64; x64; +http://www.google.com/bot.html) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36 ${generateRandomString(60,300)} ${hell}` : `Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko; compatible; Googlebot/2.1; +http://www.google.com/bot.html) Chrome/${version}.0.0.0 Safari/537.36`,
        safari: Math.random() < 0.5 ? `${generateRandomString(5,8)}+Mozilla/5.0 (Macintosh; Intel Mac OS X 10_${version}_7; +http://www.google.com/bot.html) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/${version}.0 Safari/605.1.15 ${generateRandomString(60,300)} ${hell}` : `Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko; compatible; Googlebot/2.1; +http://www.google.com/bot.html) Chrome/${version}.0.0.0 Safari/537.36`,
        brave: Math.random() < 0.5 ?`${generateRandomString(5,8)}+Mozilla/5.0 (Windows NT 10.0; Win64; x64; +http://www.google.com/bot.html) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36 ${generateRandomString(60,300)} ${hell}` : `Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko; compatible; Googlebot/2.1; +http://www.google.com/bot.html) Chrome/${version}.0.0.0 Safari/537.36`,
        firefox: Math.random() < 0.5 ?`${generateRandomString(5,8)}+Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:${version}.0; +http://www.google.com/bot.html) Gecko/20100101 Firefox/${version}.0 ${generateRandomString(60,300)} ${hell}` : `Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko; compatible; Googlebot/2.1; +http://www.google.com/bot.html) Chrome/${version}.0.0.0 Safari/537.36`,
        mobile: Math.random() < 0.5 ?`${generateRandomString(5,8)}+Mozilla/5.0 (Linux; Android 10; K; +http://www.google.com/bot.html) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Mobile Safari/537.36 ${generateRandomString(60,300)} ${hell}` : `Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko; compatible; Googlebot/2.1; +http://www.google.com/bot.html) Chrome/${version}.0.0.0 Safari/537.36`,
        opera: Math.random() < 0.5 ?`${generateRandomString(5,8)}+Mozilla/5.0 (Windows NT 10.0; Win64; x64; +http://www.google.com/bot.html) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36 OPR/${version} ${generateRandomString(60,300)} ${hell}` : `Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko; compatible; Googlebot/2.1; +http://www.google.com/bot.html) Chrome/${version}.0.0.0 Safari/537.36`,
        operagx: Math.random() < 0.5 ?`${generateRandomString(5,8)}+Mozilla/5.0 (Windows NT 10.0; Win64; x64; +http://www.google.com/bot.html) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/${version}.0.0.0 Safari/537.36 OPR/${version} ${generateRandomString(60,300)} ${hell}` : `Mozilla/5.0 AppleWebKit/537.36 (KHTML, like Gecko; compatible; Googlebot/2.1; +http://www.google.com/bot.html) Chrome/${version}.0.0.0 Safari/537.36`
    };
 ...
 const key = 'x-cache-'+ generateRandomString(3,6)
  ...
  return doiTuong;
    ...
    const TLSOPTION = {
        ciphers: cipher,
        sigalgs: sigals,
        host: generateRandomString(5,8) + "." + parsed.host,
...
//    console.log(author)
                        const head = {HeadersResponse,...header};
//console.log(head)
